...
import { FaMale, FaMapPin, FaPhone, FaPaperPlane, FaGithub, FaLinkedin, FaRssSquare } from 'react-icons/fa';
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            >
              ...
              <motion.div
                ...
                className="p-6 bg-linear-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-2xl border border-green-200 dark:border-green-800"
              >
            ...
            <motion.div
              ...
              className="bg-linear-to-br from-blue-50 to-purple-50 dark:from-gray-800 dark:to-gray-700 rounded-2xl p-8 shadow-lg"
            >
